...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        'font-heading text-lg leading-none font-semibold tracking-wide text-foreground',
        className
      )}
      {...props}
    />
